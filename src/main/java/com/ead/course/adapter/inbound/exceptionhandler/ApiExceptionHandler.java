package com.ead.course.adapter.inbound.exceptionhandler;

import com.ead.course.core.exception.CourseException;
...
import com.ead.course.adapter.response.FieldErrorDetailsResponse;
import com.ead.course.adapter.response.ProblemResponse;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handleEntityNotFoundException(final UserSubscriptionAlreadyExistsException ex, final WebRequest request){
    ...
    public ResponseEntity<?> handleEntityNotFoundException(final UserBlockedException ex, final WebRequest request){
        var status = HttpStatus.CONFLICT;
        var response = ProblemResponse.builder()
                .status(status.value())
                .timestamp(OffsetDateTime.now())
    ...
    public ResponseEntity<?> handleBusinessException(final CourseException ex, final WebRequest request){
